# 🔧 Troubleshooting Guide — Terraform Architect
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-terraform/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/terraform/)
